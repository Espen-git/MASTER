classdef capon_R_out < postprocess
...
%                     
                        ...
                        capon_minimum_variance_implementation(h,data_cube,apod_matrix,['1/1'], name);
                ...
                case dimension.transmit
                    ...
                    for n_frame = 1:h.input.N_frames
                        for n_channel = 1:h.input.N_channels
                            ...
                            capon_minimum_variance_implementation(h,data_cube,apod_matrix,[num2str(n_channel),'/',num2str(h.input.N_channels)], name);
                ...
                case dimension.receive
                    ...
                    for n_frame = 1:h.input.N_frames
                        for n_wave = 1:h.input.N_waves
                            ...
                            capon_minimum_variance_implementation(h,data_cube,apod_matrix,[num2str(n_wave),'/',num2str(h.input.N_waves)], name);
        ...
        function capon_minimum_variance_implementation(h,data_cube,apod_matrix,progress, name)
            [N,E,M] = size(data_cube);
            data_dir = strcat('C:\Users\espen\Documents\Skole\MASTER\code\data\', name);
            ...
            for e = 1:E
                ...
                for k = 1:N
                    ...
                    %else
                        ...
                        %Rinv = inv(R_sub + I_new*(h.regCoef/L_new)*trace(R_sub));
                        Ria = (R_sub + I_new*(h.regCoef/L_new)*trace(R_sub))\a;
                        
                        % save                        
                        R_path = strcat(data_dir, '\R\', name, '_', num2str(e), '_', num2str(k), '.mat');
                        Ria_path = strcat(data_dir, '\Ria\', name, '_', num2str(e), '_', num2str(k), '.mat');
                        save(R_path,'R');
                        save(Ria_path,'Ria');
